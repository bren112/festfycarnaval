...
<div className="containerPag">
  <h1>🥳NOVIDADE!</h1>
  <h2>Agora o sistema de pagamento é automático!</h2>
<img src={banner} alt="" srcset="" />
<div className="atencao">
  <p><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-browser-safari" viewBox="0 0 16 16">
...
</svg> Atenção quem usa safari abrir na guia anônima para poder rodar com mais fluidez!</p>
</div>
<br />
<a href="http://pagfestfy.x10.mx">Clique aqui </a>
</div>
